...
df.drop(df.head(len(df)%336).index,inplace=True)
len(df)
...
for i in range(336, training_data.shape[0],12):
...
history = model.fit(X_train, Y_train, epochs=70, batch_size=32, verbose=1, validation_split=0.1)


# %%


model.save("12_70_32.h5")
